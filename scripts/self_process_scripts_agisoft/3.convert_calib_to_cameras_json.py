...
def main():
    ...
    parser.add_argument('--calib', default='data1.15/process/agisoft/undiscalib/calib_undistorted.json',
                        help='Path to calibration file')
    parser.add_argument('--output', default='data1.15/process/agisoft/undiscalib/cameras.json',
